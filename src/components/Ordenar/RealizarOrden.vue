            ...
            :key="mesa.mesa.idMesa">
                ...
                <div class="box">
                    ...
                    <div class="has-text-centered">
                        <b-button type="personalizado" icon-left="check" @click="ocuparMesa(mesa)" v-if="mesa.mesa.estado === 'libre'">Ocupar</b-button>  
    ...
    methods:{
        ...
        cobrar(mesa){
            this.$buefy.dialog.prompt({
                ...
                message: `El cliente debe pagar Bs` + mesa.mesa.total,
                inputAttrs: {
                    type: 'number',
                    value:"",
                    ...
                    .then(registrado => {
                        if(registrado){
                           this.$buefy.dialog.alert({
                                ...
                                message: 'Gracias por su compra, su cambio <b>Bs' + cambio + '</b>',
                                confirmText: 'OK'
                            })
