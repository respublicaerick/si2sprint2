            ...
            <div class="column is-one-third">
                <div class="box">
                    <p class="title is-4 has-text-grey ">
                        ...
                        Ventas por hora
                        <span class="tag personalizado is-large is-pulled-right"> {{totalVentasHora}}Bs</span>
                    </p>
                </div> 
            </div>
            <div class="column is-one-third">
                <div class="box">
                    <p class="title is-4 has-text-grey ">
                        ...
                        Ventas de usuarios
                        <span class="tag personalizado is-large is-pulled-right"> {{totalVentasUsuarios}}Bs</span>
                    </p>
            ...
            <div class="column is-one-third">
                <div class="box">
                    <p class="title is-4 has-text-grey ">
                        ...
                        Ventas de la semana
                        <span class="tag personalizado is-large is-pulled-right"> {{totalVentasSemana}}Bs</span>
                    </p>
